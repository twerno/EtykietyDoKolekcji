...
function App() {
  return (
    <div className="App">
      ...
      <OkładkaA4
        countryList={[
          { countryCode: 'mu', info: ['Rupia maurytyjska', '1 rumia = 100 centów', currencyRate('mu')] },
        ]}
        includeInView={['mg', 'mz']}
        minimap="bottom-left"
      />
      ...
      <OkładkaA4
        countryList={[
          { countryCode: 'bt', info: ['Ngultrum', '1 ngultrum = 100 czetrum', currencyRate('bt')] },
